        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="py-24 xl:py-36 grid grid-cols-1 md:grid-cols-2 gap-12 items-center justify-center">
            ...
            <div className="order-1 md:order-2">
              <img src="/images/job2.png" alt="" className="w-full max-w-2xl mx-auto" />
            </div>

            <div className="order-2 md:order-1 text-center md:text-left">
              <p className="text-3xl md:text-4xl lg:text-5xl font-medium leading-snug">Find Your Dream Job or Your Ideal Candidate — All in One Place!</p>
              <p className="text-base lg:text-lg text-gray-600 mt-4">Register with Job Mela, get matched with the right opportunities, and schedule interviews in just a few clicks!</p>
